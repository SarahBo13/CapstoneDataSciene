...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        # Use entire dataframe and count total success launches per site
        fig = px.pie(
            spacex_df, 
            names='Launch Site', 
            title='Total Successful Launches by Site',
            values='class'  # Assumes 'class' is 1 for success, 0 for fail
        )
    else:
...
# Callback to update the scatter plot based on dropdown and slider input
@app.callback(
